                ...
                <form id="form-crear-pregunta" action="{{ route('crear-pregunta') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm align-middle">
                            <input type="text" class="form-control" id="texto" name="texto" placeholder="Pregunta" required>
                        </div>
                        <div class="col-sm align-middle">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a role="button" class="btn btn-info btn-sm btn-ans mr-1" data-toggle="tooltip"
                                    data-placement="top" title="Editar la Pregunta"
                                    href="/admin/preguntas/editar/{{ $pregunta->id }}"">
                                    <i class=" fas fa-plus"></i> Editar
                                </a>
                                @if ($proyecto->status == "SIN-PUBLICAR")
                                    <button type="button" class="btn btn-danger btn-sm btn-eliminar-pregunta" data-toggle="tooltip"
